    ...
    *,
    ...
    return [
        ...
        RagDocumentCreate(
            source="intent_examples",
            doc_type="intent_examples",
            version="intent.update_user_preferences.1",
            content="Please call me Marcos when you talk to me",
            metadata={"intent_type": "update_user_preferences"},
        ),
        RagDocumentCreate(
            source="intent_examples",
            doc_type="intent_examples",
            version="intent.update_user_preferences.2",
