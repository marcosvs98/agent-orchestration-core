...
class TestFlowsRepository:
    ...
    @pytest.mark.asyncio
    async def test_create_flow_persists_created_by(self, repository, database_connection):
        tenant_id = uuid4()
        flow_id = uuid4()
        name = "Test Flow"
        created_by = "user-123"
        ...
        SimpleNamespace(flow_id=flow_id, name=name, created_by=created_by)
        ...
        await repository.create_flow(tenant_id=tenant_id, name=name, created_by=created_by)
    ...
    @pytest.mark.asyncio
    async def test_create_flow_persists_description_and_tags(self, repository, database_connection):
        tenant_id = uuid4()
        flow_id = uuid4()
        name = "Test Flow"
        ...
        mock_session = MagicMock()
        SimpleNamespace(
            flow_id=flow_id, name=name, description=description, tags=tags, created_by=created_by
        )
        mock_session.add = MagicMock()
        mock_session.commit = AsyncMock()
        mock_session.refresh = AsyncMock()
    ...
    @pytest.mark.asyncio
    async def test_create_flow_persists_name_correctly(self, repository, database_connection):
        tenant_id = uuid4()
        flow_id = uuid4()
        name = "My Flow"
